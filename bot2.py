"""
Bybit Trading Bot v2.0 - Исправленная версия с учетом leverage
=============================================================

Основные исправления:
- ✅ Использование реального PNL от API Bybit
- ✅ Правильный учет leverage (плеча) при расчете PNL
- ✅ Автоматическая установка take-profit при достижении 15% PNL
- ✅ Trailing take-profit с шагом 2%
- ✅ Проверка дублирующих ордеров
- ✅ Улучшенное логирование с leverage
- ✅ WebSocket оптимизация для активных позиций
- ✅ Синхронизация с API Bybit

Формула PNL: (unrealized_pnl / position_value) * leverage
"""
...
def start_monitoring():
    logging.info("Starting bot monitoring v2.0 with leverage support...")
    users = load_users()
    if not users:
